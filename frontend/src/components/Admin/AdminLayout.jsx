...
const AdminLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/admin/foods', label: 'Foods', icon: '🍎' },
    { path: '/admin/goals', label: 'Goals', icon: '🎯' },
    { path: '/admin/tips', label: 'Tips', icon: '💡' },
    { path: '/admin/meal-logs', label: 'Meal Logs', icon: '📝' },
    { path: '/admin/meal-plans', label: 'Meal Plans', icon: '🍽️' },
    { path: '/admin/nutrition-goals', label: 'Nutrition Goals', icon: '📈' }
  ];
